...
public class BWCRSetting:ModSettings
{
	...
	public static HashSet<RelationItemDef> defaultAllowRelationItems = [BWCRDefOf.BWRFR_Child, BWCRDefOf.BWRFR_Parent, BWCRDefOf.BWRFR_Overlord, BWCRDefOf.BWRFR_Vassal];
	public static HashSet<RelationItemDef> defaultDisallowRelationItems = [BWCRDefOf.BWRFR_Group];
